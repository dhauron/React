    ...
    <Box sx={{ marginTop: "25px"}}>
      <TableContainer component={Paper}>
        <Table sx={{ minWidth: 700 }} aria-label="customized table">
          <TableHead>
            <TableRow position="static">
              <StyledTableCell align="center">Título</StyledTableCell>
              <StyledTableCell align="center">Professor(a)</StyledTableCell>
          ...
          <TableBody>
            {materias.map((materia) => (
              <StyledTableRow>
                <StyledTableCell align="center">{materia.titulo}</StyledTableCell>
                <StyledTableCell align="center">{materia.professor_nome}</StyledTableCell>
